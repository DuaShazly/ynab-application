...
internal class Authenticator(private val fragmentActivity: FragmentActivity,
                             ...
                             private val biometricChecker: BiometricChecker = BiometricChecker.getInstance(
                                 fragmentActivity
                             )
) {
    ...
    private val biometricCallback = object : androidx.biometric.BiometricPrompt.AuthenticationCallback() {
